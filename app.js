...
function agregarVendedorAction(){
  ...
  let resultado = buscarVendedor(cedula);
  if(resultado==-1){
    ...
    alert("El vendedor ya existe no se puede agregar");
  }
...
function moverAction(){
  ...
  if(resultadoBusqueda == -1) return;
  let vendedor = vendedores[resultadoBusqueda];
